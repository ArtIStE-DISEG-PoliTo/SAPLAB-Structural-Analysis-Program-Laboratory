...
plot3(ax,yyr+x,xxr+y,zzr+z,'Color',p.Results.color,'LineWidth',.1,'Tag','CONSTRAINT');
hold(ax,'on')
plot3(ax,xxp+x,yyp+y,zzp+z,'Color',p.Results.color,'LineWidth',.1,'Tag','CONSTRAINT');
