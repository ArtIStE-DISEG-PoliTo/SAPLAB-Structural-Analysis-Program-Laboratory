function rollerx3(location,varargin)
p=inputParser();
...
plot3(ax,xxr+x,yyr+y,zzr+z,'Color',p.Results.color,'LineWidth',.1,'Tag','CONSTRAINT');
hold(ax,'on')
plot3(ax,yyp+x,xxp+y,zzp+z,'Color',p.Results.color,'LineWidth',.1,'Tag','CONSTRAINT');
