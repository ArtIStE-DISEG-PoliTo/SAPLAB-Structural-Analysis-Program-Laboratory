function rollerxz3(location,varargin)
...
plot3(ax,-zzr+x,yyr+y,xxr+z,'Color',p.Results.color,'LineWidth',.1,'Tag','CONSTRAINT');
hold(ax,'on')
plot3(yyr+x,xxr+y,zzr+z,'Color',p.Results.color,'LineWidth',.1,'Tag','CONSTRAINT');
