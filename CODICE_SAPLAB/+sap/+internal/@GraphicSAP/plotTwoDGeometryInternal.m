function plotTwoDGeometryInternal(~, g, varargin)
...
for i=1:nbs
    ...
    X=[x NaN];
    Y=[y NaN];
    plot(ax,X,Y,'LineWidth',canvas.Appearance.LineWidth,'Tag', [tag, ' - Edge ' num2str(i)],'Color', canvas.Appearance.EdgeColor);
    hold(ax,'on');
end
