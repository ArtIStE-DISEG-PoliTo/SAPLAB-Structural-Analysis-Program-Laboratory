classdef HEM < fem.internal.StructuralSection

    methods ( Hidden = true ) %hidden class constructor 
        function self = HEM(nameID, varargin)
            ...
            narginchk(1,3);
            nargoutchk(0,1);
            data = readtable("+fem\+internal\+section\+data\hem.xlsx");
